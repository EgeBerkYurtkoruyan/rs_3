...
# Save submission
submission_df.to_csv('rs3/submission_v3.csv', index=False)
print("\nSubmission saved to 'rs3/submission_v3.csv'")
...
print(f"\nDate range: {train_df['timestamp_dt'].min()} to {train_df['timestamp_dt'].max()}")
